...
# !newfit command executes the get_dressed function and returns the resulting image. It accepts a value between 1 and 1111. Update this to use the command name you want and the values to fit the range of your project


@bot.command(name="outfit", brief='Dress your BAPE', description='This command will let you apply new outfits to your pfp')
    ...
    # try:
        if fit.lower() in outfits:
            if 0 < pfp_id <= 1111:
                ...
                await ctx.send('Please enter a valid number between 1 and 1111.')

        else:
            await ctx.send('Please enter a valid outfit. Check ?outfits for options')
...
#             else: await ctx.send('Please enter a valid number between 1 and 1111.')
#         else:
...
#         else: await ctx.send('Please enter a number between 1 and 1111')
